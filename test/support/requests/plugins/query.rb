  ...
  module Plugins
    module Query
      def test_plugin_query
        ...
        verify_status(response, 405) # not implemented yet
      ...
      def test_plugin_retries_query_can_be_retried
        check_error = ->(response) {
          response.is_a?(HTTPX::ErrorResponse) || response.status == 405
        }
        ...
        verify_status(retries_response, 405) # not implemented yet
