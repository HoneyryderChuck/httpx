...
module HTTPX
  ...
  class Options
    ...
    REQUEST_TIMEOUT = OPERATION_TIMEOUT = TOTAL_REQUEST_TIMEOUT = IDLE_TIMEOUT = nil
    ...
    #             <tt>:operation_timeout</tt>, <tt>:keep_alive_timeout</tt>, , <tt>:idle_timeout</tt>,
    #             <tt>:read_timeout</tt>,  <tt>:write_timeout</tt>, <tt>:request_timeout</tt> and <tt>:total_request_timeout</tt>
